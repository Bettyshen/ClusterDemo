#!/bin/bash
#SBATCH -J BirdsDetection       # name of my job
#SBATCH -p share         # name of partition/queue to use. Share partition shall be sufficient 
#SBATCH -o BirdsDetection.out        # name of output file for batch script
#SBATCH -e BirdsDetection.err        # name of error file for batch script 
...
# run R code, print output to file "BirdsDetection.out"
Rscript detectionFunction.R > BirdsDetection.out
